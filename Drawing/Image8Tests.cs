...
namespace Free.Core.Tests.Drawing
{
	...
	public class Image8Tests
	{
		...
		public static void Image8ConstructorTest()
		{
			...
			{
				var img = new Image8(1234, 345, true, true, 0x44112233, PlanarConfiguration.Continuously);
				...
				Assert.AreEqual(ChannelType.Byte, img.ChannelTypes[0]);
				Assert.AreEqual(ChannelType.Byte, img.ChannelTypes[1]);
				Assert.AreEqual(ChannelType.Byte, img.ChannelTypes[2]);
				Assert.AreEqual(ChannelType.Byte, img.ChannelTypes[3]);
				...
				{
					if (bits[i++] != 0x11) { ok = false; break; }
					if (bits[i++] != 0x22) { ok = false; break; }
					if (bits[i++] != 0x33) { ok = false; break; }
					if (bits[i++] != 0x44) { ok = false; break; }
				}
			...
			{
				var img = new Image8(1234, 345, true, true, new byte[] { 0x11, 0x22, 0x33, 0x44 }, PlanarConfiguration.Continuously);
			...
			{
				var img = new Image8(1234, 345, true, true, true, PlanarConfiguration.Continuously);
			...
			{
				var img = new Image8(1234, 345, true, true, false, PlanarConfiguration.Continuously);
			...
			{
				var img = new ChunkedImage8(1234, 345, true, true, 0x44112233, 71, PlanarConfiguration.Continuously);
			...
			{
				var img = new ChunkedImage8(1234, 345, true, true, new byte[] { 0x11, 0x22, 0x33, 0x44 }, 71, PlanarConfiguration.Continuously);
			...
			{
				var img = new ChunkedImage8(1234, 345, true, true, true, 71, PlanarConfiguration.Continuously);
			...
			{
				var img = new ChunkedImage8(1234, 345, true, true, false, 71, PlanarConfiguration.Continuously);
			...
			{
				var img = new TiledImage8(1234, 345, true, true, 0x44112233, 511, 71, PlanarConfiguration.Continuously);
			...
			{
				var img = new TiledImage8(1234, 345, true, true, new byte[] { 0x11, 0x22, 0x33, 0x44 }, 511, 71, PlanarConfiguration.Continuously);
			...
			{
				var img = new TiledImage8(1234, 345, true, true, true, 511, 71, PlanarConfiguration.Continuously);
			...
			{
				var img = new TiledImage8(1234, 345, true, true, false, 511, 71, PlanarConfiguration.Continuously);
			...
			#region Single-chunked image with init color
			{
				var img = new Image8(1234, 345, true, true, 0x44112233, PlanarConfiguration.Separated);
				...
				{
					if (bitsRed[i] != 0x11) { ok = false; break; }
					if (bitsGrn[i] != 0x22) { ok = false; break; }
					if (bitsBlu[i] != 0x33) { ok = false; break; }
					if (bitsAlp[i] != 0x44) { ok = false; break; }
				}
			...
			#region Single-chunked image with init color array
			{
				var img = new Image8(1234, 345, true, true, new byte[] { 0x11, 0x22, 0x33, 0x44 }, PlanarConfiguration.Separated);
			...
			#region Single-chunked image with init true
			{
				var img = new Image8(1234, 345, true, true, true, PlanarConfiguration.Separated);
			...
			#region Single-chunked image with init false
			{
				var img = new Image8(1234, 345, true, true, false, PlanarConfiguration.Separated);
			...
			#region Chunked image with init color
			{
				var img = new ChunkedImage8(1234, 345, true, true, 0x44112233, 71, PlanarConfiguration.Separated);
			...
			#region Chunked image with init color array
			{
				var img = new ChunkedImage8(1234, 345, true, true, new byte[] { 0x11, 0x22, 0x33, 0x44 }, 71, PlanarConfiguration.Separated);
			...
			#region Chunked image with init true
			{
				var img = new ChunkedImage8(1234, 345, true, true, true, 71, PlanarConfiguration.Separated);
			...
			#region Chunked image with init false
			{
				var img = new ChunkedImage8(1234, 345, true, true, false, 71, PlanarConfiguration.Separated);
			...
			#region Tiled image with init color
			{
				var img = new TiledImage8(1234, 345, true, true, 0x44112233, 511, 71, PlanarConfiguration.Separated);
			...
			#region Tiled image with init color array
			{
				var img = new TiledImage8(1234, 345, true, true, new byte[] { 0x11, 0x22, 0x33, 0x44 }, 511, 71, PlanarConfiguration.Separated);
			...
			#region Tiled image with init true
			{
				var img = new TiledImage8(1234, 345, true, true, true, 511, 71, PlanarConfiguration.Separated);
			...
			#region Tiled image with init false
			{
				var img = new TiledImage8(1234, 345, true, true, false, 511, 71, PlanarConfiguration.Separated);
		...
		[Test]
		public static void Image8GetChunkTest()
		{
			...
			#region Single-chunked image with init color
			{
				...
				Assert.AreEqual(ChannelType.Byte, chunk.ChannelTypes[0]);
				Assert.AreEqual(ChannelType.Byte, chunk.ChannelTypes[1]);
				Assert.AreEqual(ChannelType.Byte, chunk.ChannelTypes[2]);
				Assert.AreEqual(ChannelType.Byte, chunk.ChannelTypes[3]);
			...
			#region Single-chunked image with init color
			{
				...
				byte[] channelBitsValues = { 0x11, 0x22, 0x33, 0x44 };
				for (int channel = 0; channel < img.NumberOfChannels; channel++)
				{
					...
					byte channelBitsValue = channelBitsValues[channel];
		...
		[Test]
		public static void Image8GetTileTest()
		{
			#region GetTile(x, y)
			#region PlanarConfiguration.Continuously
			#region Single-chunked image with init color
			{
				...
				Assert.AreEqual(ChannelType.Byte, tile.ChannelTypes[0]);
				Assert.AreEqual(ChannelType.Byte, tile.ChannelTypes[1]);
				Assert.AreEqual(ChannelType.Byte, tile.ChannelTypes[2]);
				Assert.AreEqual(ChannelType.Byte, tile.ChannelTypes[3]);
		...
		[Test]
		public static void Image8IndexPropertyTest()
		{
			byte[] channelValues = new byte[] { 0x11, 0x22, 0x33, 0x44 };
			...
			#region Single-chunked image with init color
			{
				...
				Assert.AreEqual(0x44112233, img[0, 0]);
				Assert.AreEqual(0x44112233, img[100, 0]);
				Assert.AreEqual(0x44112233, img[100, 100]);
				Assert.AreEqual(0x44112233, img[1233, 344]);
			...
			#region Chunked image with init color array
			{
				var img = new ChunkedImage8(1234, 345, true, true, channelValues, 71, PlanarConfiguration.Continuously);
			...
			#region Tiled image with init color array
			{
				var img = new TiledImage8(1234, 345, true, true, channelValues, 511, 71, PlanarConfiguration.Continuously);
			...
			#region Single-chunked image with init color array
			{
				var img = new Image8(1234, 345, true, true, channelValues, PlanarConfiguration.Separated);
		...
		[Test]
		public static void Image8ClearTest()
		{
			byte[] channelValues = new byte[] { 0x14, 0x23, 0x32, 0x41 };

			int color = 0x41142332;
		...
		[Test]
		public static void Image8ClearChannelTest()
		{
			byte newBlue = 0x32;
			byte[] channelValues = new byte[] { 0, 0, newBlue, 0 };
		...
		[Test]
		public static void Image8RemoveExtraChannelTest()
		{
			byte[] channelValues = new byte[] { 0x14, 0x23, 0x32, 0x41 };
			...
			#region Single-chunked image with init true
			{
				var img = new Image8(1234, 345, true, true, channelValues, PlanarConfiguration.Continuously);

				var rgb = img.ExtraChannelRemoved();

				Assert.IsInstanceOf<Image8>(rgb);
				...
				Assert.AreEqual(img.NumberOfChunks, ((Image8)rgb).NumberOfChunks);
				Assert.AreEqual(img.ChunkHeight, ((Image8)rgb).ChunkHeight);
			...
			#region Chunked image with init true
			{
				...
				Assert.IsInstanceOf<ChunkedImage8>(rgb);
				Assert.IsNotInstanceOf<Image8>(rgb);
				...
				Assert.AreEqual(img.NumberOfChunks, ((ChunkedImage8)rgb).NumberOfChunks);
				Assert.AreEqual(img.ChunkHeight, ((ChunkedImage8)rgb).ChunkHeight);
			...
			#region Tiled image with init true
			{
				...
				Assert.IsNotInstanceOf<ChunkedImage8>(rgb);
			...
			#region Chunked image with init true
			{
				var img = new ChunkedImage8(1234, 345, true, true, channelValues, 71, PlanarConfiguration.Separated);
			...
			#region Tiled image with init true
			{
				var img = new TiledImage8(1234, 345, true, true, channelValues, 511, 71, PlanarConfiguration.Separated);
			...
			channelValues = new byte[] { 0x14, 0x23, 0x32 };

			#region RGB == RGB
			#region PlanarConfiguration.Continuously
			#region Single-chunked image with init true
			{
				var img = new Image8(1234, 345, true, false, channelValues, PlanarConfiguration.Continuously);
			...
			#region Chunked image with init true
			{
				var img = new ChunkedImage8(1234, 345, true, false, channelValues, 71, PlanarConfiguration.Continuously);
			...
			#region Tiled image with init true
			{
				var img = new TiledImage8(1234, 345, true, false, channelValues, 511, 71, PlanarConfiguration.Continuously);
			...
			#region Single-chunked image with init true
			{
				var img = new Image8(1234, 345, true, false, channelValues, PlanarConfiguration.Separated);
			...
			#region Chunked image with init true
			{
				var img = new ChunkedImage8(1234, 345, true, false, channelValues, 71, PlanarConfiguration.Separated);
			...
			#region Tiled image with init true
			{
				var img = new TiledImage8(1234, 345, true, false, channelValues, 511, 71, PlanarConfiguration.Separated);
		...
		[Test]
		public static void Image8DrawTest()
		{
			#region RGBX(C) into RGBX(C)
			{
				byte[] initColorTarget = { 0, byte.MaxValue, 0, 0 };
				byte[] initColorSource = { byte.MaxValue, 0, 0, 0x23 };

				var source = new TiledImage8(4, 4, true, true, initColorSource, 5, 3, PlanarConfiguration.Continuously);

				{
					var target = new TiledImage8(7, 7, true, true, initColorTarget, 4, 6, PlanarConfiguration.Continuously);
			...
			#region RGBX(S) into RGBX(C)
			{
				...
				var source = new TiledImage8(4, 4, true, true, initColorSource, 5, 3, PlanarConfiguration.Separated);
			...
			#region RGBX(C) into RGBX(S)
			{
				...
				{
					var target = new TiledImage8(7, 7, true, true, initColorTarget, 4, 6, PlanarConfiguration.Separated);
			...
			{
				byte[] initColorTarget = { 0, byte.MaxValue, 0 };
				byte[] initColorSource = { byte.MaxValue, 0, 0, 0x23 };

				var source = new TiledImage8(4, 4, true, true, initColorSource, 5, 3, PlanarConfiguration.Continuously);

				{
					var target = new TiledImage8(7, 7, true, false, initColorTarget, 4, 6, PlanarConfiguration.Continuously);
			...
			#region RGBX(C) into RGB(S)
			{
				...
				{
					var target = new TiledImage8(7, 7, true, false, initColorTarget, 4, 6, PlanarConfiguration.Separated);
			...
			{
				byte[] initColorTarget = { 0, byte.MaxValue, 0, 0 };
				byte[] initColorSource = { 123, 0, 0 };

				var source = new TiledImage8(4, 4, true, false, initColorSource, 5, 3, PlanarConfiguration.Continuously);
			...
			#region RGB(S) into RGBX(C)
			{
				...
				var source = new TiledImage8(4, 4, true, false, initColorSource, 5, 3, PlanarConfiguration.Separated);
			...
			{
				byte[] initColorTarget = { 32 };
				byte[] initColorSource = { 240, 180, 60, 0x23 };
				byte[] colorSource = { 160 };

				var source = new TiledImage8(4, 4, true, true, initColorSource, 5, 3, PlanarConfiguration.Continuously);

				{
					var target = new TiledImage8(7, 7, false, false, initColorTarget, 4, 6, PlanarConfiguration.Continuously);
			...
			{
				byte[] initColorTarget = { 0, byte.MaxValue, 0, 0 };
				byte[] initColorSource = { 123 };
				byte[] colorSource = { 123, 123, 123, 0 };

				var source = new TiledImage8(4, 4, false, false, initColorSource, 5, 3, PlanarConfiguration.Continuously);
			...
			{
				byte[] initColorTarget = { byte.MaxValue };
				byte[] initColorSource = { 123 };
		...
		[Test]
		public static void Image8GetSubImageTest()
		{
			byte[] initColor = { 0x11, 0x22, 0x33, 0x44 };

			#region Single-chunked Image
			{
				var img = new Image8(27, 17, true, true, initColor, PlanarConfiguration.Continuously);

				var sub = img.GetSubImage(2, 3, 4, 5);

				Assert.IsInstanceOf<Image8>(sub);
				...
				Assert.AreEqual(1, ((Image8)sub).NumberOfChunks);
				Assert.AreEqual(5, ((Image8)sub).ChunkHeight);
			...
			{
				var img = new Image8(27, 17, true, true, initColor, PlanarConfiguration.Separated);
			...
			{
				var img = new Image8(27, 17, true, false, initColor, PlanarConfiguration.Continuously);
			...
			{
				var img = new Image8(27, 17, true, false, initColor, PlanarConfiguration.Separated);
			...
			{
				var img = new Image8(27, 17, false, false, initColor, PlanarConfiguration.Continuously);
			...
			{
				var img = new ChunkedImage8(27, 17, true, true, initColor, 6, PlanarConfiguration.Continuously);

				var sub = img.GetSubImage(2, 3, 4, 7);

				Assert.IsInstanceOf<ChunkedImage8>(sub);
				Assert.IsNotInstanceOf<Image8>(sub);
				...
				Assert.AreEqual(2, ((ChunkedImage8)sub).NumberOfChunks);
				Assert.AreEqual(img.ChunkHeight, ((ChunkedImage8)sub).ChunkHeight);
			...
			{
				var img = new ChunkedImage8(27, 17, true, true, initColor, 6, PlanarConfiguration.Separated);
			...
			{
				var img = new ChunkedImage8(27, 17, true, false, initColor, 6, PlanarConfiguration.Continuously);
			...
			{
				var img = new ChunkedImage8(27, 17, true, false, initColor, 6, PlanarConfiguration.Separated);
			...
			{
				var img = new ChunkedImage8(27, 17, false, false, initColor, 6, PlanarConfiguration.Continuously);
			...
			#region Tiled Image
			{
				var img = new TiledImage8(27, 17, true, true, initColor, 4, 6, PlanarConfiguration.Continuously);

				var sub = img.GetSubImage(2, 3, 5, 7);

				Assert.IsInstanceOf<TiledImage8>(sub);
				Assert.IsNotInstanceOf<ChunkedImage8>(sub);
			...
			{
				var img = new TiledImage8(27, 17, true, true, initColor, 4, 6, PlanarConfiguration.Separated);
			...
			{
				var img = new TiledImage8(27, 17, true, false, initColor, 4, 6, PlanarConfiguration.Continuously);
			...
			{
				var img = new TiledImage8(27, 17, true, false, initColor, 4, 6, PlanarConfiguration.Separated);
			...
			{
				var img = new TiledImage8(27, 17, false, false, initColor, 4, 6, PlanarConfiguration.Continuously);
